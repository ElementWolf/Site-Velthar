export async function GET() {
  ...
  const envVars = {
    ...
    FIREBASE_SERVICE_ACCOUNT_JSON: process.env.FIREBASE_SERVICE_ACCOUNT_JSON ? 'DEFINIDA (longitud: ' + process.env.FIREBASE_SERVICE_ACCOUNT_JSON.length + ')' : 'NO DEFINIDA',
